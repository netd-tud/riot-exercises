...
you can find the [general instructions to set up your RIOT development environment](https://api.riot-os.org/getting-started.html)
and the [specific ones for the Feather Sense](https://api.riot-os.org/group__boards__adafruit-feather-nrf52840-sense.html)
